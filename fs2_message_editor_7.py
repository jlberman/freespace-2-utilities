...
def wrap_xstr(text):
    ...
    safe = text.replace('\\', '$backslash').replace('/', '$slash').replace('"', '$quote').replace(';', '$semicolon')
    ...
    def _rebuild_event_sexp(self, smc):
        def q(s):
            ...
            try:
                ...
                pass
            safe = s.replace('\\', '$backslash').replace('/', '$slash').replace('"', '$quote').replace(';', '$semicolon')
            return f'"{safe}"'
